...
if( ! class_exists( 'octagon_products_slider_module' ) ) {

	class octagon_products_slider_module {
		...
		public function __construct(){
			...
			add_shortcode( 'octagon_products_slider', array( $this, 'content' ) );
		}
		...
		public function map() {
			kc_add_map(
				array(
					'octagon_products_slider' => array(
						'name' => esc_html_x( 'Products Slider', 'shortcode-map', 'octagon-kc-elements' ),
						'icon' => 'icon-products',
		...
		public function get_slider_data( $atts ) {
			...
			$slide_data = apply_filters( 'octagon_products_slider_data', $slide_data );
		...
		public function content( $atts ) {
			...
			$output = '<div class="'. esc_attr( implode( ' ', $wrapper_class ) ) .'">';
				$output .= octagon_kc_elements_get_shortcode_template( 'products-slider-'. $style, $atts );
			$output .= '</div>';
...
new octagon_products_slider_module;