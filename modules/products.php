...
if( ! class_exists( 'octagon_products_module' ) ) {

	class octagon_products_module {
		...
		public function __construct(){
			...
			add_shortcode( 'octagon_products', array( $this, 'content' ) );

			add_action( 'wp_ajax_octagon_kc_elements_products_loadmore',  array( $this, 'loadmore' ) );
			add_action( 'wp_ajax_nopriv_octagon_kc_elements_products_loadmore', array( $this, 'loadmore' ) );
		}
		...
		public function map() {
			kc_add_map(
				array(
					'octagon_products' => array(
						'name' => esc_html_x( 'Products', 'shortcode-map', 'octagon-kc-elements' ),
						'icon' => 'icon-products',
						...
						'params' => array(
							esc_html_x( 'General', 'shortcode-map', 'octagon-kc-elements' ) => array(
								...
								array(
									'name'        => 'width',
									'label'       => esc_html_x( 'Image Width', 'shortcode-map', 'octagon-kc-elements' ),
									'type'        => 'text',
									'value'       => 785,
									'description' => esc_html_x( 'Type the image width (integer).', 'shortcode-map', 'octagon-kc-elements' )
								),

								array(
									'name'        => 'height',
									'label'       => esc_html_x( 'Image Height', 'shortcode-map', 'octagon-kc-elements' ),
									'type'        => 'text',
									'value'       => 880,
									'description' => esc_html_x( 'Type the image height (integer).', 'shortcode-map', 'octagon-kc-elements' )
								),

								array(
									'name'        => 'show_compare',
									'label'       => esc_html_x( 'Show Compare', 'shortcode-map', 'octagon-kc-elements' ),
									'type'        => 'select',
									'description' => esc_html_x( 'Show compare icon on mouse over?', 'shortcode-map', 'octagon-kc-elements' ),
									'value'       => 'show',
									'options'     => array(
								...
								array(
									'name'        => 'show_wishlist',
									'label'       => esc_html_x( 'Show Wishlist', 'shortcode-map', 'octagon-kc-elements' ),
									'type'        => 'select',
									'description' => esc_html_x( 'Show wishlist icon on mouse over?', 'shortcode-map', 'octagon-kc-elements' ),
									'value'       => 'show',
									'options'     => array(
										'show' => esc_html_x( 'Show', 'shortcode-map', 'octagon-kc-elements' ),
										'hide' => esc_html_x( 'Hide', 'shortcode-map', 'octagon-kc-elements' )
								...
								array(
									'name'        => 'view',
									'label'       => esc_html_x( 'Show Quick View', 'shortcode-map', 'octagon-kc-elements' ),
									'type'        => 'select',
									'description' => esc_html_x( 'Choose view icon on mouse over?', 'shortcode-map', 'octagon-kc-elements' ),
									'value'       => 'quick_view',
									'options'     => array(
										'quick_view' => esc_html_x( 'Quick View', 'shortcode-map', 'octagon-kc-elements' ),
										'light_box'  => esc_html_x( 'Light Box', 'shortcode-map', 'octagon-kc-elements' ),
		...
		public function content( $atts ) {
			extract( shortcode_atts( array(
				...
				'columns'       => 'columns-4', // columns-2, columns-3, columns-4, columns-5, columns-6
				'width'         => '785',
				'height'        => '880',
				'show_compare'  => 'show',
				'show_wishlist' => 'show',
			...
			$output = '<div class="'. esc_attr( implode( ' ', $wrapper_class ) ) .'">';
				$output .= octagon_kc_elements_get_shortcode_template( 'products-'. $style, $atts );
			$output .= '</div>';
		...
		public function loadmore() {
			...
			echo '<div class="ajax-content">';
				...
				echo '<div class="html-content">';
					...
					echo octagon_kc_elements_get_shortcode_template( 'products-'. $options['style'], $options );
