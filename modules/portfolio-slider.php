...
if( ! class_exists( 'octagon_kc_elements_portfolio_slider_module' ) ) {

	class octagon_kc_elements_portfolio_slider_module {
		...
		public function __construct(){
			...
			add_shortcode( 'octagon_kc_elements_portfolio_slider', array( $this, 'content' ) );
		}
		...
		public function map() {
			...
			kc_add_map(
				array(
					'octagon_kc_elements_portfolio_slider' => array(
						'name' => esc_html_x( 'Portfolio Slider', 'shortcode-map', 'octagon-kc-elements' ),
						'icon' => 'icon-portfolio',
		...
		public function get_slider_data( $atts ) {
			...
			$slide_data = apply_filters( 'octagon_portfolio_slider_data', $slide_data );
		...
		public function content( $atts ) {
			extract( shortcode_atts( array(
				'style'            => 'content-overlay', // content-overlay, content-overlap
			...
			$output = '<div class="'. esc_attr( implode( ' ', $wrapper_class ) ) .'">';
				$output .= octagon_kc_elements_get_shortcode_template( 'portfolio-slider-'. $style, $atts );
			$output .= '</div>';
...
new octagon_kc_elements_portfolio_slider_module;