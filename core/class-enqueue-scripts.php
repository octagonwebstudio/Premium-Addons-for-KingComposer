...
if( ! class_exists( 'Octagon_Core_Enqueue_scripts' ) ) {
	...
	class Octagon_Core_Enqueue_scripts {
		...
		public function enqueue_scripts() {
			...
			wp_enqueue_style( 'bootstrap', OCTAGON_CORE_URL . 'library/css/bootstrap.min.css', array(), OCTAGON_CORE_VERSION, 'all' );
			wp_enqueue_style( 'icon-basic', OCTAGON_CORE_URL . 'assets/css/icon-basic.css', array(), OCTAGON_CORE_VERSION, 'all' );
			wp_enqueue_style( 'icon-social', OCTAGON_CORE_URL . 'assets/css/icon-social.css', array(), OCTAGON_CORE_VERSION, 'all' );
			wp_enqueue_style( 'octagon', OCTAGON_CORE_URL . 'assets/css/octagon.css', array(), OCTAGON_CORE_VERSION, 'all' );
			
			wp_register_style( 'magnific-popup', OCTAGON_CORE_URL . 'library/css/magnific-popup.min.css', array(), OCTAGON_CORE_VERSION, 'all' );
			wp_register_style( 'slick', OCTAGON_CORE_URL . 'library/css/slick.min.css', array(), OCTAGON_CORE_VERSION, 'all' );
			...
			wp_enqueue_script( 'octagon-core-tools', OCTAGON_CORE_URL . 'assets/js/tools.js', array( 'jquery' ), '1.0', false );
			...
			octagon_concatenate_localize_scripts( 'octagon-core-scripts', 'octagon_localize', $object );
		}
		...
		public function admin_enqueue_scripts( $hook ) {
			...
			wp_enqueue_style( 'octagon-core-admin', OCTAGON_CORE_URL . 'assets/css/admin.css', array() , OCTAGON_CORE_VERSION, 'all' );
			wp_enqueue_style( 'octagon-icon', OCTAGON_CORE_URL . 'assets/css/octagon-icon.css', array() , OCTAGON_CORE_VERSION, 'all' );
			...
			wp_enqueue_script( 'octagon-core-admin', OCTAGON_CORE_URL . 'assets/js/admin.js' , array( 'jquery' ), OCTAGON_CORE_VERSION );
